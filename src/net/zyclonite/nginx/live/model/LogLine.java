...
package net.zyclonite.nginx.live.model;

import io.vertx.core.json.JsonObject;
import net.zyclonite.nginx.live.annotation.Queryable;
...
import static net.zyclonite.nginx.live.util.JsonObjectHelper.putNonNull;
